...
<div class="">
            ...
            <?php flash('register_success'); ?>
                <form action="<?php echo URLROOT; ?>/users/login" method="post" class="w-25 d-flex justify-content-center flex-column align-items-center">
                    ...
                    <input type="submit" value="Login" class="w-100 btn btn-Subscribe text-light btn-block">
                    <p class="text-light">Don't have an account? <a href="<?php echo URLROOT; ?>/users/register">Sign Up</a></p>
                  </form>
            </div>
        </div>
