<div class="d-flex flex-column p-3 text-white bg-blue w-25 vh-100 sticky-top" >
            ...
            <ul class="nav nav-pills flex-column mb-auto">
              <li class="nav-item btn-dash p-2 rounded-1">
                <a href="#" class=" active text-light text-decoration-none " aria-current="page">
                    <i class="fas fa-tachometer-alt"></i>
                    dashboard
                </a>
              </li>
              <?php if(isset($_SESSION['user_id'])) : ?>
              <li class="nav-item btn-dash mt-2 p-2 rounded-1">
                <a href="<?php echo URLROOT; ?>/users/login" class=" active text-light text-decoration-none " aria-current="page">
