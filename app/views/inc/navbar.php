<div class="bg-blue">
        <div class="container">
            <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 ">
              <a href="<?php echo URLROOT; ?>" class="logo d-flex align-items-center col-md-3 mb-2 mb-md-0 text-dark text-decoration-none">
              ...
              <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                <li><a href="<?php echo URLROOT; ?>" class="nav-link px-2 active-l">Home</a></li>
                <li><a href="#" class="nav-link px-2 link-light">Computer Science</a></li>
                <li><a href="#" class="nav-link px-2 link-light">Data Structure</a></li>
                <li><a href="#" class="nav-link px-2 link-light">Php</a></li>
                <li><a href="#" class="nav-link px-2 link-light">Vue.Js</a></li>
              </ul>


              <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                <li><a class="nav-link link-light me-2 btn btn-Subscribe" href="<?php echo URLROOT; ?>/users/login">Login</a></li>
                <li><a class="nav-link link-light btn btn-Subscribe" href="<?php echo URLROOT; ?>/users/register">Register</a></li>
              </ul>
          
              <!-- <div class="col-md-2 text-end">
              <a class="nav-link" href="<?php //echo URLROOT; ?>/users/login">Login</a>
              <a class="nav-link" href="<?php //echo URLROOT; ?>/users/register">Register</a>
                <i class="fas fa-search px-2 link-light"></i>
                <i class="fab fa-facebook-f px-2 link-light"></i>
                <i class="fab fa-twitter px-2 link-light"></i>
