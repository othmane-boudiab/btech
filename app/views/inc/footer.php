  ...
  <footer class="bg-blue text-center text-lg-start">
        ...
        <div class="container p-4">
          ...
          <div class="row">
            ...
            <!--Grid column-->
            <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
              <h5 class="text-uppercase text-light">Newsletter</h5>
      
              <div class="form-outline mb-4">
                <input type="email" id="form5Example2" class="mt-4 mb-3 form-control" placeholder="Email address..."/>
                <button type="submit" class="w-100 text-light btn btn-Subscribe mb-4">
                    Subscribe
                  </button>
              </div>
            </div>
        ...
        <div class="text-center text-light p-3" style="background-color: rgba(0, 0, 0, 0.2);">
          © 2021 Copyright:
          <a class="text-light" href="#">B-Tech Company</a>
        </div>
        <!-- Copyright -->
      </footer>
